...
fn parse_trial(chars: &Vec<char>, trial: &Vec<u32>, cant_be_zero: &[char], map: &mut HashMap<char, u32>) -> bool {
...
fn is_valid(puzzle: &Vec<&str>, chars: &Vec<char>, trial: &Vec<u32>, cant_be_zero: &[char], map: &mut HashMap<char, u32>) -> bool {
...
pub fn solve(input: &str) -> Option<HashMap<char, u8>> {
    ...
    let initials: HashSet<char> = words.clone().into_iter().map(|w| w.chars().next().unwrap()).collect();
